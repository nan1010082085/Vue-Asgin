		...
		<Form class="form" label-width="100px" label-position="left">
			<FormItem label="侧边导航">
				<div class="form-item" @click="handlePattern('side')">
					<img :class="{'menu-active' : sideMenu}" src="https://gw.alipayobjects.com/zos/rmsportal/JopDzEhOqwOjeNTXkoje.svg" alt="sidemenu">
				</div>
			</FormItem>
			<FormItem label="顶部导航">
				<div class="form-item" @click="handlePattern('top')">
					<img :class="{'menu-active' : topMenu}" src="https://gw.alipayobjects.com/zos/rmsportal/KDNDBbriJhLwuqMoxcAr.svg" alt="topmenu">
				</div>
