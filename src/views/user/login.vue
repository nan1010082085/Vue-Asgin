		...
		<div class="form-warp">
			<Form v-show="!rapid" class="form" ref="form" :model="loginForm" :rules="ruleForm" label-width="80px"
				...
				<Row class="form-header">
					<Col :span="12"><h1>登录平台</h1></Col>
					<Col :span="12" class="tar" v-if="false">
						<Button type="text" @click="handleTigger('form')">快捷登录</Button>
					</Col>
				</Row>
				<FormItem label="帐号" prop="phone">
					<Input class="form-login-inp"
								 size="small"
								 @keyup.native.13="handleSubmit('form')"
								 v-model="loginForm.phone" placeholder="登录帐号"/>
				</FormItem>
				<FormItem label="密码" prop="pass">
					<Input class="form-login-inp"
								 ...
								 type="password"
								 @keyup.native.13="handleSubmit('form')"
								 v-model="loginForm.pass" placeholder="登录密码"/>
				</FormItem>
				<FormItem label="验证码" prop="code">
					<Input class="form-login-inp-code"
								 size="small"
								 @keyup.native.13="handleSubmit('form')"
				...
				<FormItem prop="">
					<Button class="form-submit" size="small" type="primary" @click.native="handleSubmit('form')">登录</Button>
				</FormItem>
			</Form>
			<!-- 快捷登录 -->
